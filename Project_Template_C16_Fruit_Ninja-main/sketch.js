...
var knifeSound, knifeFruitSound
...
function preload(){
  ...
  knifeSound = loadSound("gameover.mp3")
  knifeFruitSound = loadSound("knifeSwoosh.mp3")
...
function setup() {
  ...
  //creating sword
   ...
   knife.scale=0.7
   //knife.loadSound("swoosh", KnifeSound)
